...
public:
	...
	void ClearAbilitiesOfSlot(const FGameplayTag& Slot);  // Removes InputTag (slot) from any Ability that has it (only one Ability is supposed to have this same InputTag (slot))
