...
void UAuraAttributeSet::HandleIncomingXP(FEffectProperties& Props)
{
	...
	// Source Character is the owner since GA_ListenForEvents applies GA_EventBasedEffect, adding to IncomingXP
...
{ // will break if enemy attacking the Aura will die after the stun effect was applied
