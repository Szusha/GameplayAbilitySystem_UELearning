...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	*/
	...
	GameplayTags.Abilities_Passive_ListenForEvent = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Abilities.Passive.ListenForEvent"), FString("ListenForEvent tag"));
	...
	*/
	...
	GameplayTags.GameplayCue_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("GameplayCue.FireBlast"), FString("GameplayCue Tag for FireBlast"));
}
